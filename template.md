...
![Stacked distribution of images in training and test dataset](./img/train_test_qty.png){width=55%}
...
![Exemples of images used in this pratical work](./img/tiles.png){width=70%}
...
![Experiment 1 - Training and Validation Loss and Accuracy for 34 layers](./img/32l_128_graph.png){width=85%}

![Experient 1 - Confusion matrix for 34 layers](./img/32l_128.png){width=50%}

**Re-train 96 layers**

![Experient 1 - Training and Validation Loss and Accuracy for 96 layers](./img/96l_128_graph.png){width=85%}

![Experient 1 - Confusion matrix for 96 layers](./img/96l_128.png){width=50%}

**Re-train 123 layers**

![Experiment 1 - Training and Validation Loss and Accuracy for 123 layers](./img/123l_128_graph.png){width=85%}

![Experient 1 - Confusion matrix for 123 layers](./img/123l_128.png){width=50%}
...
![Experiment 1 - Heatmaps of Code Snippets](./img/heatmap.png){width=75%}
...
![Exemples of resized images used in this pratical work](./img/cropped.png){width=70%}
...
![Experiment 2 - Training and Validation Loss and Accuracy for 123 layers](./img/2nd_123l_32-32_graph.png){width=85%}

![Experient 2 - Confusion matrix for 123 layers](./img/2nd_123l_32-32_matrix.png){width=50%}

**Re-train 96 layers**

![Experiment 2 - Training and Validation Loss and Accuracy for 96 layers](./img/2nd_96l_32-32_graph.png){width=85%}

![Experient 2 - Confusion matrix for 96 layers](./img/2nd_96l_32-32_matrix.png){width=50%}

**Re-train 23 layers**

![Experiment 2 - Training and Validation Loss and Accuracy for 23 layers](./img/2nd_23l_32-32_graph.png){width=85%}

![Experient 2 - Confusion matrix for 23 layers](./img/2nd_23l_32-32_matrix.png){width=50%}
...
![Experiment 2 - Heatmaps of Code Snippets](./img/heatmap_2nd_exp.png){width=75%}
...
![Exemples of using the Android App](./img/mobile.png)
